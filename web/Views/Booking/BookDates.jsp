...
<div class="reg">
		...
		<div class="book-pag">
			...
			<div class="book-pag-frm1">
				...
				<input class="date" name="Date1" id="datepicker1" type="text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required>
			</div>
			<div class="book-pag-frm2">
				<label>Check Out</label>
				<input class="date" name="Date2" id="datepicker2" type="text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required>
			</div>
		<div class="clear"></div>
		</div>	
